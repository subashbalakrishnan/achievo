    ...
    $db_username = "iqss_iqssdotin";   // username MySQL server  
    $db_password = "iq$$!n2012";   // password MySQL server  
    $db_name = "iqss_india";       // database name  
   ...
   // $sql .= " LIKE '%" . $pattern . "%'";  
    ...
    {  
      ...
      $new_table_name = $table_name."_"."bk";
	  echo $table_name."->".$new_table_name."<br>";
