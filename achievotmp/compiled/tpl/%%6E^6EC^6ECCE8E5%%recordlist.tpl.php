<?php /* Smarty version 2.6.11, created on 2013-07-31 23:58:13
...
', <?php echo $this->_tpl_vars['row']['rownum']; ?>
              ...
              <?php $_from = $this->_tpl_vars['row']['cols']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['col']):
?>
                <<?php if ($this->_tpl_vars['row']['type'] == 'subtotal'): ?>th<?php else: ?>td<?php endif; ?> valign="<?php echo $this->_tpl_vars['vorientation']; ?>
" <?php if (isset ( $this->_tpl_vars['col']['htmlattributes'] )):  echo $this->_tpl_vars['col']['htmlattributes'];  endif; ?>
                  <?php if ($this->_tpl_vars['col']['type'] == 'data'): ?> onclick="rl_try('<?php echo $this->_tpl_vars['listid']; ?>
