<?php /* Smarty version 2.6.11, created on 2013-04-01 03:39:56
         compiled from ./atk/themes/achievo_modern/templates/recordlist.tpl */ ?>
...
?>
                <<?php if ($this->_tpl_vars['row']['type'] == 'subtotal'): ?>th<?php else: ?>td <?php if ($this->_sections['colloop']['index'] === 0): ?>class="recordListTdFirst"<?php else: ?>class="recordListTd"<?php endif; ?>
                 <?php endif; ?> valign="<?php echo $this->_tpl_vars['vorientation']; ?>
