<?php /* Smarty version 2.6.11, created on 2013-03-28 06:29:47
...
<?php if (! $this->_tpl_vars['login_logo']):  echo smarty_function_atkconfig(array('var' => 'theme_logo','smartyvar' => 'login_logo'), $this); endif; ?>
<?php if (! $this->_tpl_vars['login_logo']):  ob_start();  echo smarty_function_atkthemeimg(array('0' => "login_logo.jpg"), $this); $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('login_logo', ob_get_contents());ob_end_clean();  endif; ?>
<?php if (! $this->_tpl_vars['login_logo']):  ob_start();  echo smarty_function_atkthemeimg(array('0' => "logo.jpg"), $this); $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('login_logo', ob_get_contents());ob_end_clean();  endif; ?>
<?php echo '
<style type="text/css">
body
{
