<?php /* Smarty version 2.6.11, created on 2013-07-31 23:59:16
         compiled from ./atk/themes/basic/templates/tabs.tpl */ ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
    <span onclick="showTab('<?php echo $this->_tpl_vars['tabs'][$this->_sections['i']['index']]['tab']; ?>
')" id="tab_<?php echo $this->_tpl_vars['tabs'][$this->_sections['i']['index']]['tab']; ?>
" class="atktab">
